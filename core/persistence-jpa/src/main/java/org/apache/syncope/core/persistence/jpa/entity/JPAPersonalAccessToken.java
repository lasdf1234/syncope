...
@Entity
@Table(name = JPAPersonalAccessToken.TABLE)
@Cacheable
public class JPAPersonalAccessToken extends AbstractProvidedKeyEntity implements PersonalAccessToken {

    public static final String TABLE = "PersonalAccessToken";
